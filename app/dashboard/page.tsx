  ...
  return (
    <PageLayout>
      <div className="mx-10 py-10 pl-5">
        <p className="text-6xl py-10 font-bold text-[#2F3E46]">Dashboard</p>
        <div className="lg:flex space-x-5">
          <Select
            ...
            className="text-[#2F3E46] w-[15rem]"
          />
          <Select
            className="text-[#2F3E46]"
            options={options}
            isMulti
          ...
          />
          <p className="text-[#2F3E46] mt-2 fond-bold">From:</p>
          <Datepicker
          ...
          <p className="text-[#2F3E46] mt-2 fond-bold"> To:</p>
          <Datepicker
