    ...
    <PageLayout>
      <main className="flex min-h-screen flex-col items-center justify-center">
        ...
        <div className="mt-6 text-2xl">
          Let us take the sting out of booking venues. Let us know your dates
          below.
        </div>

        <div className="flex items-center flex-col py-8 ">
          <h1 className="text-4xl text-[#606C38] font-extrabold mb-2">
            Step 1
          </h1>
          <button
            className="bg-[#BC6C25] text-white font-bold py-2 px-4 rounded mb-12 text-2xl"
            onClick={openSheet}
          >
          ...
          >
            ...
            <button
              type="submit"
              className="bg-[#BC6C25] items-center cursor-pointer text-white font-bold py-2 px-4 rounded mb-12 mt-6 text-2xl"
            >
              Submit{" "}
            </button>
          </form>
